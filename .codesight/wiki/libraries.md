...
**40 library files** across 2 modules
...
- `client/src/api/useTransactions.ts` — useTransactions, useTransaction, useCreateTransaction, useUpdateTransaction, useDeleteTransaction, useGetBillMatches
...
- `client/src/api/useBankMatchingRules.ts` — useBankMatchingRules, useCreateBankMatchingRule, useUpdateBankMatchingRule, useDeleteBankMatchingRule, useSimulateBankMatchingRule
...
- `client/src/utils/trainFromFeed.ts` — extractTrainPattern, buildTrainFromFeedDraft, TrainFromFeedRowInput, TrainFromFeedDraftResult
...
- `server/services/bankTransactions/ruleEngine.ts` — evaluateBankTransactionRule, validateBankMatchingRuleDraft, simulateBankMatchingRule, upsertBankMatchingRule, listBankMatchingRules, softDeleteBankMatchingRule, …
