...
> 74 routes (74 inferred) | 0 models | 27 components | 22 lib files | 13 env vars | 8 middleware
> **Token savings:** this file is ~4,500 tokens. Without it, AI exploration would cost ~65,800 tokens. **Saves ~61,300 tokens per conversation.**
> **Last scanned:** 2026-04-14 04:11 — re-run after significant changes
...
- `server/utils/date.ts` — imported by **10** files
...
- `server/services/churchTimeZone.ts` — imported by **6** files
...
- `server/db/index.js` ← `server/routes/accounts.ts`, `server/routes/auth.ts`, `server/routes/bills.ts`, `server/routes/contacts.ts`, `server/routes/fiscalPeriods.ts` +11 more
...
- `client/src/components/ui/Select.jsx` ← `client/src/components/ExpenseBreakdown.jsx`, `client/src/pages/Bills.jsx`, `client/src/pages/ChartOfAccounts.jsx`, `client/src/pages/Contacts.jsx`, `client/src/pages/DonationReceipts.jsx` +5 more
