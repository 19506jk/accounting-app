...
> 0 routes | 0 models | 0 components | 14 lib files | 13 env vars | 7 middleware | 221 import links
> **Token savings:** this file is ~2,100 tokens. Without it, AI exploration would cost ~16,300 tokens. **Saves ~14,100 tokens per conversation.**
...
- `client/src/utils/date.ts` — imported by **8** files
- `client/src/components/ui/Table.jsx` — imported by **8** files
- `client/src/components/ui/Select.jsx` — imported by **7** files
- `client/src/components/ui/Badge.jsx` — imported by **7** files
- `server/utils/date.ts` — imported by **7** files
- `client/src/api/useAccounts.ts` — imported by **6** files
- `client/src/components/ui/Modal.jsx` — imported by **6** files
- `client/src/api/useContacts.ts` — imported by **5** files
- `client/src/api/useFunds.ts` — imported by **5** files
- `server/services/churchTimeZone.ts` — imported by **5** files
- `server/types/db.ts` — imported by **5** files
...
- `client/src/components/ui/Toast.jsx` ← `client/src/main.jsx`, `client/src/pages/Bills.jsx`, `client/src/pages/ChartOfAccounts.jsx`, `client/src/pages/Contacts.jsx`, `client/src/pages/DepositEntry.jsx` +5 more
- `client/src/components/ui/Card.jsx` ← `client/src/pages/Bills.jsx`, `client/src/pages/ChartOfAccounts.jsx`, `client/src/pages/Contacts.jsx`, `client/src/pages/Dashboard.jsx`, `client/src/pages/Funds.jsx` +5 more
- `client/src/components/ui/Button.jsx` ← `client/src/pages/Bills.jsx`, `client/src/pages/ChartOfAccounts.jsx`, `client/src/pages/Contacts.jsx`, `client/src/pages/DepositEntry.jsx`, `client/src/pages/Funds.jsx` +5 more
...
- `client/src/components/ui/Input.jsx` ← `client/src/pages/Bills.jsx`, `client/src/pages/ChartOfAccounts.jsx`, `client/src/pages/Contacts.jsx`, `client/src/pages/DepositEntry.jsx`, `client/src/pages/Funds.jsx` +4 more
...
- `client/src/utils/date.ts` ← `client/src/api/useDashboard.ts`, `client/src/components/ui/DateRangePicker.jsx`, `client/src/pages/ChartOfAccounts.jsx`, `client/src/pages/Dashboard.jsx`, `client/src/pages/DepositEntry.jsx` +3 more
