...
export interface TemplateDropdownTemplate {
  id: string
  name: string
  rows: unknown[]
}
...
interface TemplateDropdownProps {
  templates: TemplateDropdownTemplate[]
  isOpen: boolean
  onToggle: () => void
  onLoad: (template: TemplateDropdownTemplate) => void
  onDelete: (id: string) => void
}

const TemplateDropdown = forwardRef<HTMLDivElement, TemplateDropdownProps>(function TemplateDropdown(
